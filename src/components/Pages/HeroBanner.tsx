    ...
    return (
        <section className="px-2 lg:px-0">
            <motion.div
                ...
                className={`relative w-full rounded-2xl lg:rounded-[32px] overflow-hidden bg-gradient-to-br ${theme.gradient} shadow-[0_20px_50px_rgba(0,0,0,0.3)] group h-[220px] sm:h-[280px] lg:h-[350px] transition-colors duration-1000`}
            >
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-between p-4 sm:p-6 lg:p-12">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="flex flex-col items-start w-full lg:w-2/3 space-y-2 sm:space-y-3 lg:space-y-6 text-right"
                        >
                            {/* Animated Badge */}
                            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-white/10 border border-white/20 text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider backdrop-blur-md">
                            ...
                            <div className="space-y-1 lg:space-y-3">
                                <h1 className="text-xl sm:text-2xl lg:text-5xl font-black text-white font-cairo leading-tight drop-shadow-lg">
                                    {currentTool.titleAr}
                                </h1>
                                <p className="text-xs sm:text-sm lg:text-lg text-white/90 max-w-xl font-cairo leading-relaxed font-medium drop-shadow-md line-clamp-2 lg:line-clamp-none">
                                    {currentTool.descAr}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 pt-1">
                                <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 bg-black/20 border border-white/10 rounded-lg text-[10px] sm:text-xs text-white/70 font-mono backdrop-blur-sm">
                            ...
                            <div className="pt-1 sm:pt-2 lg:pt-4">
                                <button
                                    ...
                                    className="relative group overflow-hidden px-4 py-2 sm:px-6 sm:py-3 lg:px-8 lg:py-4 rounded-xl font-bold text-white bg-white/10 border border-white/20 transition-all hover:bg-white/20 hover:scale-105 active:scale-95 shadow-xl backdrop-blur-md touch-manipulation"
                                >
                                    <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity" />
                                    <div className="relative flex items-center gap-2 lg:gap-3">
                                        <span className="text-xs sm:text-sm lg:text-base font-cairo font-black">جربه الآن</span>
                                        <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 rtl:rotate-180" />
                                    </div>
                                </button>
                            </div>
                        </motion.div>
