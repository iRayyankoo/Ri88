                            ...
                            <div className="relative rounded-[36px] bg-surface-raised/40 p-8 lg:p-12 space-y-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className="group relative w-full flex items-center justify-center gap-4 bg-white text-gray-800 border border-gray-200 font-black py-4.5 rounded-2xl hover:scale-[1.02] hover:shadow-xl active:scale-[0.98] transition-all shadow-lg overflow-hidden"
                                    >
                                        ...
                                        <span className="relative font-cairo text-lg text-gray-800 font-bold">
